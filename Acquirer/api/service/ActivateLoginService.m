...
#import "ActivateLoginService.h"
#import "Acquirer.h"
#import "AcquirerCPRequest.h"
#import "DeviceIntrospection.h"
#import "ACUser.h"

@implementation ActivateLoginService
...
-(void)requestForActivateLogin:(NSString *)activateSTR withPass:(NSString *)newPassSTR{
    ...
    [acReq onRespondTarget:self selector:@selector(activateLoginRequestDidFinished:)];
    [acReq execute];
}

-(void)activateLoginRequestDidFinished:(AcquirerCPRequest *)req{
